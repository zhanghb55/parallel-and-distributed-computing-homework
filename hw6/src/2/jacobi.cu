...
{ 
    ...
    CUDA_CHECK( cudaMemcpy(phi, phi_d, sizeof(double)*N*N, cudaMemcpyDeviceToHost));
    CUDA_CHECK( cudaMemcpy(phiPrev, phiPrev_d, sizeof(double)*N*N,cudaMemcpyDeviceToHost));
